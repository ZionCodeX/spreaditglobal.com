...
$e_subject = 'Shipping Only Submission';
...
$e_body = "You have been contacted by $name, from Shipping Only Web Contact form, their message is as follows.:<br>" . PHP_EOL . PHP_EOL;
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<p>Thank you <strong>$name</strong>, your message has been submitted to us. You will</p>";
	echo "</div>";
